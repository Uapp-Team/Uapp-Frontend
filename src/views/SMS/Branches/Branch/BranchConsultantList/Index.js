...
const Index = () => {
  ...
  console.log(consultantList, "guru amr");
  ...
  useEffect(() => {
    get(
      `Consultant/GetPaginated?page=${currentPage}&pageSize=${dataPerPage}&searchstring=${searchStr}&consultantTypeId=${empValue}&branchId=${id}&status=${statusValue}`
    ).then((res) => {
