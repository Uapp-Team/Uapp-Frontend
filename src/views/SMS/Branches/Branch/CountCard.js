    ...
    <Row>
      <Col md={3} xs={6} className="mb-30px">
        <DashboardCount
          ...
          link={`/applicationsbybranch/${id}/${intakeRngValue}`}
          bgColor="#E1F5FC"
          borderColor="#24A1CD"
        />
      </Col>
      <Col md={3} xs={6} className="mb-30px">
        <DashboardCount
          ...
          // link={`/applicationsByBranchStatus/${id}/${5}/${1}/${intakeRngValue}`}
          bgColor="#FBF5E8"
          borderColor="#FFBA08"
        />
      </Col>
      <Col md={3} xs={6} className="mb-30px">
        <DashboardCount
          ...
          link={`/applicationsByBranchStatus/${id}/${2}/${2}/${intakeRngValue}`}
          bgColor="#F8F3FF"
          borderColor="#AE75F8"
        />
      </Col>
      <Col md={3} xs={6} className="mb-30px">
        <DashboardCount
          ...
          link={`/applicationsByBranchStatus/${id}/${2}/${3}/${intakeRngValue}`}
          bgColor="#F0FFE0"
          borderColor="#70E000"
        />
      </Col>
      <Col md={3} xs={6} className="mb-30px">
        <DashboardCount
          ...
          // link={`/applicationsByBranchStatus/${id}/${12}/${1}/${intakeRngValue}`}
          bgColor="#FEF6F5"
          borderColor="#F87675"
        />
      </Col>
      <Col md={3} xs={6} className="mb-30px">
        <DashboardCount
          ...
          link={`/applicationsByBranchStatus/${id}/${4}/${3}/${intakeRngValue}`}
          bgColor="#EDF1F5"
          borderColor="#34495E"
        />
      </Col>
