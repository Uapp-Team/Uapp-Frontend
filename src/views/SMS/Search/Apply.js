...
const Apply = ({
  ...
  console.log(elStatus?.admissionRequirements?.length, "elSTATus");
  ...
  return (
    <>
      {/* <div className="d-flex justify-content-between align-items-center px-3 border-bottom-apply-course">
        <div className="my-3">
          {" "}
          <h3 className="">Apply Course</h3>
        </div>
        <div>
      ...
      <Form onSubmit={submitModalForm}>
        <ModalBody className="overflowY-search-modal-630px">
          ...
          <Row className="px-3">
            ...
            {/* <Col lg="6" className="applyleft my-3"></Col> */}
          </Row>
        </ModalBody>
