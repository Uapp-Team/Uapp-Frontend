...
const Scholarship = ({ studentid, success, setSuccess }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!FileList1) {
      setSelfError("Please upload attatchment");
    } else {
    ...
    <div>
      <Form onSubmit={handleSubmit}>
        <Input
          ...
          value={studentid}
        />
        {scholarshipFunding?.id ? (
          <input
            type="hidden"
            name="id"
            id="id"
            value={scholarshipFunding?.id}
          />
        ) : null}
        <Row>
          {" "}
        ...
        <Row>
          <Col lg="6" md="8">
            <div>
              ...
              />{" "}
              <span>
                I confirm that all the information provided regarding my source
                of funds is true, complete and accurate.
              </span>
            </div>
          </Col>
        </Row>
