...
const StudentDocumentForm = () => {
  ...
  useEffect(() => {
    get(`StudentConsent/Get/${idVal}`).then((res) => {
      setConscentData(res);
    });
  ...
  const finish = () => {
    ...
    setProgress(true);
    put(`StudentConsent/SendEmail/${idVal}`).then((res) => {
      setProgress(false);
    ...
    <div>
      <Card className="uapp-card-bg">
        <CardHeader className="page-header">
          <h3 className="text-white">Student Terms & Conditions</h3>
          <div className="page-header-back-to-home">
            <span className="text-white"> 92% Completed</span>
          </div>
        </CardHeader>
      </Card>
          ...
          <div className="container">
            <div>
              <div>
                <h5 className="mb-3">
                  {" "}
                  <b className="bg-u">Terms & Conditions</b>{" "}
                </h5>
              </div>
              <span className="conscentText-style">
                I hereby agree and accept that SMS Higher Education Group
                (SMSHEG) have the authority of processing personal data
                contained in this form or other data which SMSHEG may obtain
                from other people and sources. I agree also to the processing of
                such data for any purposes connected with my University
                Admission requirements or any legitimate reason including
                communication with me following the completion of my admission
                and enrolment. In addition, I agree to allow SMSHEG processing
                personal data described as Special Category Data as defined
                under the General Data Protection Regulation. The processing to
                be undertaken for any purposes as indicated in the declaration
                above. In addition to the Privacy Notice linked to this form
                please also see our Corporate Privacy Policy on our website;{" "}
                <Link to="/https://smsheg.co.uk/404" target="_blank">
              ...
              <br />
              <span className="conscentText-style">
                1. I understand and accept this statement.
              </span>

              <br />

              <span className="conscentText-style">
                2. I have submitted all documents relevant to my application
                including all qualifications studied either in the UK or
                overseas. I take full responsibility and accountability for the
                originality of the certificates.
              </span>

              <br />

              <span className="conscentText-style">
                3. I certify that the qualifications submitted for admission
                purposes are certified and awarded to me and I have given
                permission to SMSHEG to verify and cross check them. I
                understand that proving a false declaration is totally
                unacceptable and is deemed to be malpractice and/or fraud.
              </span>

              <br />

              <span className="conscentText-style">
                4. My contact information is up-to-date and will inform the
                University I apply to of any change, and I will notify the
                University promptly of any changes to the information which I
                have submitted an application on enrolment.
              </span>
              ...
              <>
                ...
                conscentData?.consentSignStatusId == 1 ? (
                  <div className="mb-1 text-right">
                    <p style={{ fontWight: "500" }}>
                      Send consent sign request email to student.
                    </p>
                    <Button
                      color="primary"
                      onClick={finish}
