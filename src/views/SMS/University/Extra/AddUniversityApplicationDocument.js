...
//       get(`UniversityApplicationDocument/GetByUniversity/${univerId}`).then(
//         (res) => {
...
//                                 permissionList?.Add_New_universityApplicationdocument ||
//                                   permissionList?.Update_universityApplicationdocument_info
//                               ) ? (
//                                 <ButtonForFunction
//                                   color={"primary"}
//                                   type={"submit"}
...
//                             /> */}
//                               {permissions?.includes(
//                                 permissionList?.Delete_universityApplicationdocument
//                               ) ? (
//                                 <ButtonForFunction
//                                   className={"mx-1 btn-sm"}
...
//                                   <b>{applicationName}</b> ? Once Deleted it
//                                   can't be Undone!
//                                 </p>
//                               </ModalBody>
