...
const AddUniProfileSubject = () => {
  ...
  const toggle = (tab) => {
    ...
    if (id != undefined) {
      ...
      if (tab == "5") {
        history.push(
          `/addUniProfileSubjectDocumentRequirement/${id}/${subjId}`
        );
      }
    } else {
      if (tab == "2") {
      ...
      if (tab == "5") {
        history.push(
          `/addUniProfileSubjectDocumentRequirement/${id}/${subjectId}`
        );
      }
    }
  };
              ...
              <Form onSubmit={handleSubmit} className="mt-5">
                ...
                <FormGroup row className="has-icon-left position-relative">
                  ...
                  <Col md="6">
                    ...
                    {subDeptDropError && (
                      <span className="text-danger">
                        You must select sub-department.
                      </span>
                    )}
                  </Col>
                </FormGroup>
