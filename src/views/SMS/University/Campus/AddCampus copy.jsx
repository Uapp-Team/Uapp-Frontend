            ...
            <Row>
              ...
              <Col lg="4" md="5" className="pl-sm-30px mr-sm-30px">
                <div className="row d-flex align-items-center mb-1">
                  <span className="col-9 text-md-right">Total student: </span>
                ...
                <div className="row d-flex align-items-center mb-1">
                  <span className="col-9 text-md-right">
                ...
                <div className="row d-flex align-items-center mb-1">
                  <span className="col-8 text-md-right">
                    Avg. tuition fee:{" "}
                  </span>

                  <InputGroupText className="col-1">£</InputGroupText>
                  <Input
                    className="col-3"
                    type="number"
                    min="0"
