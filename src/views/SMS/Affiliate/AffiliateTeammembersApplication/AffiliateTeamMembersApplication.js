...
const AffiliateTeamMembersApplication = () => {
  ...
  useEffect(() => {
    get(
      `AffiliateApplication/Index?page=${currentPage}&pagesize=${dataPerPage}&affiliateid=${affiliateId}&enrollmentStatus=${false}`
    ).then((res) => {
      setLoading(false);
...
export default AffiliateTeamMembersApplication;
