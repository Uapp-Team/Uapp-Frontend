...
const AffiliateNewDeclaration = () => {
  ...
  useEffect(() => {
    userType === userTypes?.SystemAdmin
      ? get(
          `UserTermsAndConditions/Get/${userTypes?.Affiliate}/${affiliateId}`
        ).then((res) => {
          setLoading(false);
  ...
  return (
    <div>
      ...
      <BreadCrumb
        ...
        backTo={affiliateId ? "Terms & Conditions" : null}
...
export default AffiliateNewDeclaration;
