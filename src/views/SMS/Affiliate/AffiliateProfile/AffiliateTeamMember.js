...
const AffiliateTeamMember = ({ affiliateProfileData, affiliateId }) => {
      ...
      <Card className="p-4">
        <div className="d-flex mb-4">
          ...
          <span className="count-summery">
            {affiliateProfileData?.data?.teamMembers?.length}
          </span>
        </div>

        {affiliateProfileData?.data?.teamMembers.map((details) => (
