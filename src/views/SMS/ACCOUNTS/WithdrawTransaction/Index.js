...
const Index = () => {
  ...
  useEffect(() => {
    // get(
    //   `WithdrawRequest/Transactions?page=${currentPage}&pagesize=${dataPerPage}&consultantId=${consultantValue}&payment=${paymentValue}&trcode=${transactionCode}`
    // ).then((res) => {
    //   setData(res?.models);
    ...
    get(
      `WithdrawRequest/Transactions?page=${currentPage}&pagesize=${dataPerPage}&consultantId=${consultantValue}&payment=${paymentValue}&trcode=${transactionCode}&fromrequest=${fromrequest}&torequest=${torequest}&frompayment=${frompayment}&topayment=${topayment}&branchid=${branchValue}`
    ).then((res) => {
      console.log(res);
      setData(res?.models);
      setEntity(res?.totalEntity);
                ...
                <Table id="table-to-xls" className="table-sm table-bordered">
                  <thead className="tablehead">
                    <tr style={{ textAlign: "center" }}>
                      ...
                      {tableData[2]?.isActive ? <th>Consultant Name</th> : null}
                  ...
                  <tbody>
                    {data?.map((ls, i) => (
                      <tr key={i} style={{ textAlign: "center" }}>
                        ...
                        {tableData[4]?.isActive ? <td>£{ls?.amount}</td> : null}
