...
const Menu = (props) => {
  ...
  const handleSubmit = (event) => {
    ...
    post(`MenuItem/Create`, subData).then((action) => {
  ...
  const parentMenutitles = parentMenuitems?.map((pm) => ({
    label: pm.title,
    value: pm.id,
  }));
        ...
        <CardBody>
          <Form onSubmit={handleSubmit} ref={myForm}>
            <FormGroup row>
              ...
              <UncontrolledTooltip placement="top" target="titleTooltip">
                Your Menu Title
              </UncontrolledTooltip>
              <Col md="10" lg="6">
                <Input
            ...
            <FormGroup row>
              ...
              <UncontrolledTooltip placement="top" target="iconTooltip">
                Your Menu Icon
              </UncontrolledTooltip>
            ...
            {type == "item" && (
              <FormGroup row>
                <Col md="2">
                  <i
                    id="parentIdTooltip"
                    class="fas fa-info-circle menuIcon"
                  ></i>
                  <span className="pl-2">Parent</span>
                </Col>
                <UncontrolledTooltip placement="top" target="parentIdTooltip">
                  Parent Menu's Title
                </UncontrolledTooltip>

                <Col md="10" lg="6">
                  <Select
                    options={parentMenutitles}
                    value={{ label: parentTitle, value: parentValue }}
                    onChange={(opt) =>
                      selectparentMenutitles(opt.label, opt.value)
                    }
                    name="parentId"
                    id="parentId"
                    required
            ...
            <FormGroup row>
              ...
              <UncontrolledTooltip placement="top" target="orderTooltip">
                Order
              </UncontrolledTooltip>
              <Col md="10" lg="6">
                <Input
