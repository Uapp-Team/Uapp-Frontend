...
const Country = () => {
  ...
  return (
    <div>
      <BreadCrumb title="Country List" backTo="" path="" />
                  ...
                  <tr key={index} list={list}>
                    ...
                    <td>
                      <ButtonGroup variant="text">
                        <Button className="btn-sm mx-2" color="danger">
                          <i className="fas fa-trash-alt"></i>
                        </Button>

                        <Button
                          color="warning"
                          onClick={() => handleUpdateCountry(list?.id)}
                          className=" btn-sm"
                        >
                          {" "}
                      ...
                      <Modal isOpen={deleteModal} className="uapp-modal">
                        <ModalBody>
                          <p>
                            ...
                            {localStorage.getItem("depName")} ? Once Deleted it
                            can't be Undone!
                          </p>
                        </ModalBody>
