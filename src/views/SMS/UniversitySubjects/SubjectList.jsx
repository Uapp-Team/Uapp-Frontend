...
const SubjectList = (props) => {
  ...
  useEffect(() => {
    if (location?.universityId) {
      ...
      get(`UniversityCampus/GetbyUniversity/${location?.universityId}`).then(
        (res) => {
                ...
                <div className="table-responsive" ref={componentRef}>
                  <Table id="table-to-xls" className="table-sm table-bordered">
                    ...
                    <th>Duration</th> */}
                        ...
                        {checkProg ? <th>Education Level</th> : null}
                    ...
                    <tbody>
                      ...
                      <td>
                        {sub?.duration}
                          ...
                          {checkProg ? (
                            <td>{sub?.educationLevelName}</td>
                          ) : null}

                          {checkDep ? <td>{sub?.departmentName}</td> : null}

                          {checkSubDep ? (
                            <td>{sub?.subDepartmentName}</td>
                          ) : null}
