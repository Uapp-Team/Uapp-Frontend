...
//       setProviderValue(res?.provider?.id);
//       setProviderLabel(res?.provider?.name);
...
//           <h3 className="text-white">Admission Manager Information</h3>
...
//                   required
//                   defaultValue={updateData?.postCode}
//                 />
//               </Col>
//             </FormGroup>
...
//             <FormGroup row className="has-icon-left position-relative">
//               <Col md="2">
//                 <span className="pl-2">State/County</span>
//               </Col>
//               <Col md="4">
//                 {/* <Select
//                   options={stateName}
...
//                   defaultValue={updateData?.stateName}
//                 />
//               </Col>
//             </FormGroup>
...
// export default AddAdmissionManagerPage;
