...
const Index = () => {
  ...
  useEffect(() => {
    ...
    get(
      `AdmissionOfficerInformation/GetPersonalInformation/${admissionOfficerId}`
    ).then((res) => {
  ...
  const handleSubmit = (event) => {
    ...
    subdata.append("coverImageFile", FileList2[0]?.originFileObj);
    subdata.append("phoneNumber", phoneNumber);

    let CheckFileIsValid = () => {
      if (
        consPersonalInfo?.profileImage == null &&
    ...
    if (ValidForm()) {
      ...
      setProgress(true);
      put("AdmissionOfficerInformation/PersonalInformation", subdata).then(
        (res) => {
          setProgress(false);
          setSuccess(!success);
  ...
  return (
    <div>
      <BreadCrumb
        title="Admission Officer Personal Information"
        backTo={
                            ...
                            {consPersonalInfo?.profileImage != null ? (
                              <div className="col-md-6">
                                <Image
                                  ...
                                  src={
                                    rootUrl +
                                    consPersonalInfo?.profileImage?.thumbnailUrl
                                  }
                                />
                              </div>
                            ) : null}
                  ...
                  <Row>
                    <Col lg="6" md="8">
                      <FormGroup row>
                        ...
                        <Col md="5">
                          <div className="row">
                            {consPersonalInfo?.coverImage != null ? (
                              <div className="col-md-6">
                                <Image
                                  width={104}
                                  height={104}
                                  src={
                                    rootUrl +
                                    consPersonalInfo?.coverImage?.thumbnailUrl
                                  }
                                />
                              </div>
                            ) : null}
