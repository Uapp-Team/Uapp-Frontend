          ...
          <div className="d-flex justify-content-center">
            <div className="w-50 my-5">
              <div className="register-header">
                ...
                <h1 style={{ fontSize: "18px" }}>Registration is successful</h1>
                <p className="my-4" style={{ fontSize: "14px" }}>
                  {" "}
                  Your consultant account has been created successfully, login
                  to your portal to complete your profile and start helping
                  student to apply.
                </p>
              </div>
...
export default ConsultantAccountCreateSuccessfully;
