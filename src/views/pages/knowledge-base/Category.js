          ...
          <Col lg="4" md="6" sm="12">
            <Card>
              ...
              <CardBody className="knowledge-base-category">
                <ListGroup flush>
                  <ListGroupItem>
                    <Link to="/pages/knowledge-base/category/questions">
            ...
            <Card>
              ...
              <CardBody className="knowledge-base-category">
                <ListGroup flush>
                  ...
                  <ListGroupItem>
                    <Link to="/pages/knowledge-base/category/questions">
                      Cheesecake sweet soufflé jelly tiramisu chocolate?
                    </Link>
                  </ListGroupItem>
                  <ListGroupItem>
                    <Link to="/pages/knowledge-base/category/questions">
                  ...
                  <ListGroupItem>
                    <Link to="/pages/knowledge-base/category/questions">
                      Ice cream soufflé marshmallow?
                    </Link>
                  </ListGroupItem>
                  <ListGroupItem>
                    <Link to="/pages/knowledge-base/category/questions">
                      Dragée liquorice dragée jelly beans?
                    </Link>
                  </ListGroupItem>
                  <ListGroupItem>
                    <Link to="/pages/knowledge-base/category/questions">
