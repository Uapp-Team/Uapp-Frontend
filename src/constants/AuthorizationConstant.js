export const permissionList = {
  ...
  View_Application_List: 100,
  View_Application_Details: 101,
  Delete_Application_Details: 102,

  Update_Application_Assesment: 103,
  Update_Application_Info: 104,

  Delete_Application_Document: 105,
  Add_Application_Document: 106,

  Add_ApplicationInterview: 107,
  Add_ApplicationELPT: 108,

  Add_ApplicationNote: 109,
  View_ApplicationNote: 110,
  Add_ApplicationMessage: 111,
  View_ApplicationMessage: 112,

  Change_Admission_Manger: 113,
  ...
  Delete_Branch: 222,
  View_Branch: 223,
  View_Branch_List: 224,

  Add_Branch_Employee: 225,
  Edit_Branch_Employee: 226,
  Delete_Branch_Employee: 227,
  View_Branch_Employee: 228,

  ////// commission
  //desingations
  View_DesignationList: 130,
  Edit_Designation: 131,
  Change_Consultant_designation: 132,
  Pay_Designation_Bonus: 133,

  //Account Intakes
  View_Account_Intake_List: 134,
  Add_Account_Intake: 135,
  Edit_Account_Intake: 136,
  Delete_Account_Intake: 137,

  //Commission
  View_Commission_Structure: 138,
  Configure_CommissionStucture: 139,

  //Accounts
  // application transaction
  View_Application_Transactions: 140,
  Update_Transaction_Status: 141,
  Add_Transaction_Note: 142,
  Add_Transaction_Installment: 143,

  // Account transaction
  View_Account_Transactions: 144,
  View_Account_Transaction_Details: 145,
  Add_Inflow_Transaction: 146,
  View_Inflow_Transaction: 147,
  Add_Outflow_Transaction: 148,
  View_Outflow_Transaction: 149,

  //Widthdraw
  Add_Widthdraw_Request: 150,
  View_Widthdraw_Request: 151,
  Update_Withdraw_Request_Authorize_Status: 152,
  Update_Withdraw_Request_Payment_Status: 153,
  View_Consultant_Balance: 154,

  /////consultant

  Add_Consultant_type: 50,
  Edit_Consultant_type: 51,
  Delete_Consultant_type: 52,
  View_Consultant_type_List: 53,

  //Consutlants
  Add_Consultant: 54,
  Edit_Consultant: 55,
  Delete_Consultant: 56,
  Change_Consultant_AccountStatus: 57,
  View_Consultant: 58,
  View_Consultant_list: 59,
  View_Consultant_Dashboard: 60,
  View_Consultant_Student: 61,
  ...
  Configure_Documents: 251,
  Configure_Educationlevels: 252,

  Role_Configuration: 253,
  Role_Menu_Configuration: 254,
  Role_Permission_Configuration: 255,
  ...
  Update_Employee: 2,
  Delete_Employee: 3,
  View_Employee_list: 4,
  View_Employee_Details: 5,

  Add_Staff_type: 6,
  Edit_Staff_type: 7,
  Delete_Staff_type: 8,
  View_Staff_type_list: 9,

  Add_AdmissionManager: 10,
  Update_AdmissionManager: 11,
  Delete_AdmissionManager: 12,
  View_AdmissionManager_list: 13,
  View_AdmissionManager_Details: 14,
  AdmissionManager_Assign_University: 15,
  AdmissionManager_Assign_Subject: 16,
  AdmissionManager_Assign_AdmissionOfficer: 17,

  Add_AdmissionOfficer: 18,
  Update_AdmissionOfficer: 19,
  Delete_AdmissionOfficer: 20,
  View_AdmissionOfficer_list: 21,
  View_AdmissionOfficer_Details: 22,
  AdmissionOfficer_Assign_University: 23,
  AdmissionOfficer_Assign_Subject: 24,

  AdmissionManager_Account_Status: 25,
  AdmissionOfficer_Account_Status: 26,
  Staff_Password_Change: 27,
  Change_Employee_Account_Status: 28,
  ...
  Delete_Provider: 202,
  View_Provider: 203,
  View_Provider_List: 204,
  Change_Provider_Account_Status: 205,
  ...
  Delete_Student: 32,
  View_Student: 33,
  View_Student_list: 34,
  Change_Student_Account_Status: 35,
  Change_ProfilePhoto: 36,
  Change_CoverPhoto: 37,

  //documents
  Upload_Student_Document: 38,
  Delete_Student_Document: 39,

  //password
  Change_Student_Password: 40,

  //document

  Add_Student_Document_Level: 41,
  Edit_Student_Document_Level: 42,
  View_Student_Document_Level: 43,
  ...
  Add_University: 81,
  Edit_University: 82,
  Delete_University: 83,
  View_University: 84,
  View_University_List: 85,
  Change_University_Status: 86,
  ...
  // //branchEmployee
  // View_Branch_AccountsManager_List: 33,
  // View_Branch_Editor_List: 34,
  // View_Branch_AccountsOfficer_List: 35,
  // View_Branch_FinanceManager_List: 36,
  // View_Branch_ComplianceManager_List: 37,
  ...
  // View_Subject_Test_Requirement_List: 343,
  // Add_New_Subject_Test_Requirement: 344,
  // Update_Subject_Test_Requirement_info: 345,
  // View_Subject_Test_Requirement_info: 346,
  // Delete_Subject_Test_Requirement: 347,
  ...
  // Change_Branch_Manager_profileImage: 551,
  // Change_Provider_Admin_profileImage: 552,
